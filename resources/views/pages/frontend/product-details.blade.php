            ...
            <div class="col-lg-7 pb-5">
                            ...
                            @foreach ($product->sizes as $size)
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input size_input"
                                        id="{{ $size->size_name . '-' . $size->id }}" name="size"
                                        value="{{ $size->id }}">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    <div class="input-group quantity mr-3" style="width: 130px;">
                        ...
                        <input type="text" class="form-control bg-secondary text-center quantity_input" min="1"
                            value="1">
                        <div class="input-group-btn">
        ...
        <div class="row px-xl-5">
            <div class="col">
                ...
                <ul class="nav nav-tabs justify-content-center border-secondary mb-4" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="pills-reviews-tab" data-toggle="pill" href="#pills-review"
                                        ...
                                        <div class="media mb-4">
                                            ...
                                            <div class="media-body">
                                                <h6>{{ $review->user->first_name . ' ' . $review->user->last_name }}<small>
                                                        -
                                                        <i>{{ \Carbon\Carbon::parse($review->created_at)->setTimezone('Asia/Dhaka')->format('d
                                                                                                        F Y h:i a') }}</i></small>
                                                </h6>
                            ...
                            <div
                                ...
                                <a href="{{ route('product_details', ['id' => $item->id, 'slug' => $item->slug]) }}">
                                    <img class="img-fluid w-100"
                                        src="{{ $item->productImages->first()
                                            ? asset($item->productImages->first()->product_image)
                                            : asset('assets/eshoper/img/product-2.jpg') }}"
                                        alt="">
                                </a>
                            </div>
