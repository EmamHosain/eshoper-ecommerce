...
<div class="col-lg-4 col-md-6 col-sm-12 pb-1">
    <div class="card product-item border-0 mb-4">
        ...
        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
            <a href="{{ route('product_details', ['id' => $product->id, 'slug' => $product->slug]) }}">
                <h6 class="text-truncate mb-3 text-capitalize">{{ $product->category->category_name }}-{{
                    $product->popularity }}-{{
        ...
        <div class="card-footer d-flex justify-content-between bg-light border">
            <a href="javascript:void(0)" data-id="{{ $product->id }}" class="btn btn-sm text-dark p-0 add_to_wishlist">
                <i class="fas fa-heart text-primary mr-1"></i>Add To
                Wishlist
            </a>


            <a href="javascript:void(0)" data-id="{{ $product->id }}" class="btn btn-sm text-dark p-0 add_to_cart"><i
