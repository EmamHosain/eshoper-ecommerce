...
<div class="container-fluid py-2 px-xl-5">
    ...
    <section class="bg-light py-3 py-md-5 contact_container">
        <div class="container">
                            ...
                            {{-- <div class="d-flex">
                                ...
                                <div>
                                    ...
                                    <div class="d-flex mb-1">
                                        <p class=" fw-bold mb-0 me-5">Mon - Fri</p>
                                        <p class=" ml-2 mb-0">9am - 5pm</p>
                                    </div>
                                    <div class="d-flex gap-2">
                                        <p class=" fw-bold mb-0 me-5">Sat - Sun</p>
                                        <p class=" mb-0 ml-2">9am - 2pm</p>
                                    </div>
