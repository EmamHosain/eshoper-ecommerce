                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 form-group">
                            ...
                            <select class="form-control" id="shipping_area" name="shipping_area">
                                ...
                                <option class=" text-capitalize" value="{{ $item->id }}">{{ $item->shipping_name }} -
                                    ${{ $item->amount }}
                                </option>
                                @endforeach
                            </select>
                            <p id="shipping_area" style="font-size: 13px"></p>
                        </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.errors) {
                            ...
                            window.location.href = "{{ route('thanks_page',':order_id') }}".replace(':order_id',response.order_id)
                        }
                    },
                    error: function(xhr, status, error) {
                        // Handle server errors
