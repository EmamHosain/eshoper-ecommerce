                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 form-group">
                            ...
                            <select class="form-control" id="shipping_area" name="shipping_area">
                                ...
                                <option class="text-capitalize" value="{{ $item->id }}" @selected(!empty($customer->
                                    shipping_manage_id) && $item->id === $customer->shipping_manage_id)>
            ...
            <div class="col-lg-4">
                ...
                <div class="card border-secondary mb-3">
                    ...
                    <div class="card-body">
                        ...
                        {{-- <div class="form-group">
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" name="payment_method" id="bkash"
                                    value="bkash">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" name="payment_method" id="nagad"
                                    value="nagad">
