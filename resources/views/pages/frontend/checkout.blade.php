                            ...
                            <div class="col-12 col-md-6 form-group">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input shipping_type"
                                            name="shipping_type" checked id="cash_on_delivery" value="cash_on_delivery">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input shipping_type"
                                            name="shipping_type" id="inside_dhaka" value="inside_dhaka">
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-radio">
                                        <input type="radio" class="custom-control-input shipping_type"
                                            name="shipping_type" id="outside_dhaka" value="outside_dhaka">
            ...
            $('.shipping_type').on('change', function() {
                if ($(this).is(':checked')) {
                    ...
                    if (value === 'inside_dhaka') {
                        $('#shipping_cost').text("$70");
                        shipping_charge = 70;

                    } else if (value === 'outside_dhaka') {
                        $('#shipping_cost').text("$150");
                        shipping_charge = 150;
