...
<nav class="app-header navbar navbar-expand bg-body">
    ...
    <div class="container-fluid">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-md-block"> <a href="{{ route('index') }}" class="nav-link">Home</a> </li>
        ...
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown"> <a class="nav-link" data-bs-toggle="dropdown" href="#"> <i
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <a href="#" class="dropdown-item">
                        <!--begin::Message-->
                        <div class="d-flex">
                            <div class="flex-shrink-0"> <img src="{{ asset('assets/eshoper/img/user.jpg') }}"
            ...
            <li class="nav-item dropdown user-menu">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                    ...
                    <img src="{{ asset('assets/eshoper/img/user.jpg') }}" class="user-image rounded-circle shadow"
                        alt="User Image">
                    @else
                ...
                <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                    ...
                    <li class="user-header text-bg-primary">
                        @if (empty($admin->photo))
                        <img src="{{ asset('assets/eshoper/img/user.jpg') }}" class="rounded-circle shadow"
                            alt="User Image">
                        @else
                    ...
                    <li class="user-footer">
                        <a href="{{ route('admin.profile_page') }}" class="btn btn-success">Profile</a>
