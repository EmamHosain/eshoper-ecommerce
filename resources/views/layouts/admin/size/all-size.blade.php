    ...
    <div class="app-content-header mb-3">
        ...
        <div class="container-fluid">
            ...
            <div class="container d-flex justify-content-between align-items-center">
                <div class="col-sm-6">
                    <h3 class="mb-0">All Size</h3>
                </div>
                <div class="">
                    <a class="btn btn-primary" href="{{ route('admin.add_size') }}">Add Size</a>
                </div>
            </div>
            <!--end::Row-->
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        var table = $('#datatable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('admin.all_size') }}", // Change this route to fetch all sizes
            columns: [
                { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false }, // Serial number (Si) column
                { data: 'size', name: 'size' }, // Column for size name
