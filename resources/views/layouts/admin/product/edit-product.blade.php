                        ...
                        <form action="{{ route('admin.update_product', $product->id) }}" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div id="image-{{ $item->id }}" class="col-2 position-relative mb-3">
                                        <img src="{{ asset($item->product_image) }}" class="img-thumbnail">
                                        <a href="javascript:void(0)"
                                            onclick="deleteImage({{ $item->id }},{{ $product->id }})"
                                ...
                                @else
                                <label class="form-label">There is no exiting product image</label>
                                @endif
