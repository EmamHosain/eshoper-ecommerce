    ...
    <div class="app-content-header mb-3">
        ...
        <div class="container-fluid">
            ...
            <div class="container d-flex justify-content-between align-items-center">
                ...
                <div class="">
                    <a class="btn btn-primary" href="{{ route('admin.all_category') }}">All Category</a>
                </div>
            </div>
            <!--end::Row-->
        </div>
                    ...
                    <div class="card card-primary card-outline mb-4">
                        ...
                        <form action="{{ route('admin.update_category', $category->id) }}" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <img src="{{ $category->category_logo ? asset($category->category_logo) : asset('assets/empty-image-300x240.jpg') }}"
                                    id="categoryLogoPreview" alt="Category Logo" class="d-block me-4 img-thumbnail mb-2"
